      ...
      <form action="cartElement.php" method="post" target="dummyframe">
        <div class="centering">
          <button type="submit" id="buttons">
            <img src="images/red-recycle-bin-icon-20.png" alt="Red Trash Can" style="width:20px; height:20px;">
          </button> 
      ...
      $total_price += $i['quantity']* (-1 * (($i['profit']/ $i['quantity']) - ($i['quantityXproductPrice'] / $i['quantity'])));
        ...
        <div class="items">
               <strong>Total Price</strong>
                ...
                <img src="images/red-recycle-bin-icon-20.png" alt="Red Trash Can" class="left-icon">
                </button>
