...
<div class=y>
<div class="box">
  <a href="all.php" style="text-decoration:none;">All</a>
</div>
<div class="box">
  <a href="CannedFood.php" style="text-decoration:none;">Canned Food</a>
</div>
<div class="box">
  <a href="Greens.php" style="text-decoration:none;">Greens</a>
</div>
<div class="box">
  <a href="Drinks.php" style="text-decoration:none;">Drinks</a>
</div>
<div class="box">
  <a href="CleaningSupplies.php" style="text-decoration:none;">Cleaning supplies</a>
</div>
<div class="box">
  <a href="Candy.php" style="text-decoration:none;">Candy</a>
</div></div>
<div class="whitePage">
        <div class=h5><h5 class=h> Featured Products</h5>
        <a  class =button href="all.php" style="text-decoration:none;"> Show All</a>
        </div>
        <style>
        ...
        .h {
            ...
            margin-top: 10px;
             ...
             <div class="trendCenter">
                ...
                <div class="trends"> 
                    <div class="container">
                    <a href="Candy.php"> <img  id="img5" src="images/American-Candy-Social-IMG.jpg"></a>
                </div>
                </div>
                <div class="trends"> 
                    <div class="container">
                    <a href="Drinks.php"><img  id="img6" src="images/bottled-soft-drinks.webp"></a>
                </div>
                </div>
                <div class="trends"> 
                    <div class="container">
                    <a href="Greens.php"><img id="img7" src="images/7.jpg"></a>
                </div>
                </div>
                </div>
            </div>
